...
export interface ChroniclePriceProviderInterface extends utils.Interface {
  functions: {
  ...
  decodeFunctionResult(functionFragment: "chronicle", data: BytesLike): Result;
  ...
  decodeFunctionResult(functionFragment: "selfKisser", data: BytesLike): Result;
...
export interface ChroniclePriceProvider extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ChroniclePriceProviderInterface;
  ...
  functions: {
    ...
    selfKisser(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    selfKisser(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    selfKisser(overrides?: CallOverrides): Promise<PopulatedTransaction>;
