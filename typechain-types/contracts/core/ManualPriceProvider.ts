...
export interface ManualPriceProviderInterface extends utils.Interface {
  functions: {
...
export interface ManualPriceProvider extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ManualPriceProviderInterface;
